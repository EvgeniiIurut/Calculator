...
public class Calculator {
    public String startCalc(String str) {
        Stack<Double> numbers = new Stack<>(); // stack for accumulate all the numbers
        ...
        for (int i = 0; i < chars.length; i++) {
            if (chars[i] == ' ' && signs.empty()) {
                ...
                while (!signs.empty()) {
                    double variable1 = numbers.pop();
                    double variable2 = numbers.pop();
                    k_numbers -= 2;
                    switch (signs.peek()) {
                        case "*":
            ...
            /*----------------------------------------------------------------------*/
            else if ((chars[i] <= '9' && chars[i] >= '0')||chars[i]=='.') {
                temp_number.append(chars[i]);
                if (((i + 1) < chars.length) && (chars[i+1]!='.') && (chars[i + 1] < '0' || chars[i + 1] > '9')) {
                    numbers.push(Double.parseDouble(temp_number.toString()));
                    k_numbers++;
            ...
            /*-----------------------------------------------------------------------*/
                ...
                if (signs.peek().equals("+") || signs.peek().equals("-")) {
                    numbers.push(Double.parseDouble(chars[i + 1] + ""));
                    double variable1 = numbers.pop();
                    double variable2 = numbers.pop();
                    k_numbers -= 2;
